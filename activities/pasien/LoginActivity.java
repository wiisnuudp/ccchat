...
//                    signInWithEmailAndPassword(emailLogin, passwordLogin, view);
    ...
    private void login(){
        ...
        database.collection("Users")
                .whereEqualTo("email",binding.emailLogin.getText().toString())
                .whereEqualTo("password", binding.passwordLogin.getText().toString())
                    ...
                    && task.getResult().getDocuments().size() > 0)
            {
                ...
                preferenceManager.putString("uid", documentSnapshot.getId());
